        ...
        if (session) {
          ...
          const historyList = messages.map((msg) => {
            ...
            return {
              ...
              name: isFromSelf ? "customer service" : "me",
              avatar: isFromSelf
  ...
  useEffect(() => {
    ...
    const handleMessage = (data) => {
      ...
      const newMsg = {
        ...
        name: isFromSelf ? "me" : "customer service",
        avatar: isFromSelf
          ? "https://picsum.photos/40/40?random=user"
          : "https://picsum.photos/40/40",
    ...
    <div className="chat-page">
      <div className="chat-header">
        <Button
          ...
          onClick={() => navigate(-1)}
        />
        <div className="chat-title">MALL</div>
      </div>
      ...
      <div className="chat-footer">
        <div className="chat-footer-inner">
          <Input
            ...
            placeholder="Please enter the content of your inquiry...."
            onPressEnter={send}
          />
          <Button
            type="primary"
